...
export default function Scene() {
  ...
  const { 
    ...
    ambientColor: { value: '#a0c0ff', label: "Ambient Color" },
    ...
    spot1Color: { value: '#ffffff', label: "Spot 1 Color" },
    ...
    spot2Color: { value: '#a0ffff', label: "Spot 2 Color" },
    ...
    spot3Color: { value: '#a0ffff', label: "Spot 3 Color" },
  ...
  return (
    <>
      ...
      />
      <spotLight position={[spot1PosX, spot1PosY, spot1PosZ]} decay={0} distance={45} penumbra={1} intensity={spot1Intensity} color={spot1Color} />
      <spotLight position={[spot2PosX, spot2PosY, spot2PosZ]} color={spot2Color} angle={0.15} decay={0} penumbra={-1} intensity={spot2Intensity} />
      <spotLight position={[spot3PosX, spot3PosY, spot3PosZ]} color={spot3Color} angle={0.2} decay={0} penumbra={-1} intensity={spot3Intensity} />
      <CameraControls />
    </>
  )
}